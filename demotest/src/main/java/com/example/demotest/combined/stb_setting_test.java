...
public class stb_setting_test {
    ...
    public void Test1() throws InterruptedException {
        ...
        System.out.println("[STB] 電視修改暱稱測試 開始");
        Reporter.log("[STB] 電視修改暱稱測試 開始");
        ...
        System.out.println("[STB] 設定功能測試");
        Reporter.log("[STB] 設定功能測試");
        Thread.sleep(1000);
        ...
        System.out.println("[STB] 修改暱稱");
        Reporter.log("[STB] 修改暱稱");
        Thread.sleep(1000);

        driver.pressKey(new KeyEvent(AndroidKey.PROG_GREEN));
        System.out.println("[STB] 按綠鍵修改暱稱");
        Reporter.log("[STB] 按綠鍵修改暱稱");
        Thread.sleep(1000);

        Thread.sleep(3000);
        driver.pressKey(new KeyEvent(AndroidKey.DIGIT_1));
        System.out.println("[STB] 更改名字輸入1");
        Reporter.log("[STB] 更改名字輸入1");

        Thread.sleep(3000);
        driver.pressKey(new KeyEvent(AndroidKey.DIGIT_2));
        System.out.println("[STB] 更改名字輸入2");
        Reporter.log("[STB] 更改名字輸入2");

        Thread.sleep(3000);
        driver.pressKey(new KeyEvent(AndroidKey.DIGIT_3));
        System.out.println("[STB] 更改名字輸入3");
        Reporter.log("[STB] 更改名字輸入3");

        System.out.println("[手機] 更改完畢按確認");
        Reporter.log("[STB] 更改完畢按確認");
        driver.pressKey(new KeyEvent(AndroidKey.DPAD_CENTER));  //按按鍵往下
        Thread.sleep(3000);
        ...
        driver.pressKey(new KeyEvent(AndroidKey.DPAD_UP));  //按按鍵往下
        Thread.sleep(3000);
        ...
        String elText5 = elsetting2.getText();
        System.out.println("欄位名稱:" + elText5);

        if(elText5.equals("設定"))
        {
            System.out.println("[STB] 成功移動至設定區");
            Reporter.log("[STB] 成功移動至設定區");
        }
        ...
        System.out.println("[STB] 改回暱稱");
        Reporter.log("[STB] 改回暱稱");
        Thread.sleep(1000);
        ...
        MobileElement elname2 = (MobileElement) driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.webkit.WebView/android.webkit.WebView/android.view.View[2]/android.view.View[1]/android.view.View[2]");
        String elText6 = elname2.getText();
        System.out.println("帳戶名稱:" + elText6);

        if(elText6.equals("冠綸爺爺"))
        {
            System.out.println("[STB] 用戶暱稱恢復成功");
            Reporter.log("[STB] 用戶暱稱恢復成功");
        }
        else
        {
